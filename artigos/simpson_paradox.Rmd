...
Eaí? Acertou a direção?! A interpretação que damos a esse gráfico é: a relação entre a profundidade do bico e o tamanho do bico é decrescente, isto é, quando maior `bill_depth_mm` menor é o valor de `bill_length_mm`, visto que a reta de regressão linear entre os dois tem inclinação para baixo, apesar da pouca intensidade. É basicamente isso que o gráfico mostra, mais estatisticamente falando, poderíamos dizer, pela análise visual, que essas duas variáveis possuem **correlação negativa entre si**. 
...
O paradoxo foi descrito pelo matemático e estatístico Edward Simpson em um *paper* em 1951, apesar de efeito similares serem descritos anteriormente por outros estatísticos. Há diversos exemplos envolvendo este paradoxo, e  suas aplicações envolvem desde abstrações simples, como a que fizemos com o *dataset* dos pinguins à amostras sobre saúde.  